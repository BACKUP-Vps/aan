...
<li>
  ...
  <div class="collapse" id="operations_menu" aria-expanded="true">
    <ul class="nav">
      ...
      @ability('admin', 'fleet')
      <li><a href="{{ url('/admin/subfleets') }}"><i class="pe-7s-plane"></i>Frota</a></li>
      @endability
      ...
      <li><a href="{{ url('/admin/finances') }}"><i class="pe-7s-display1"></i>Finanças</a></li>
      @endability

      @ability('admin', 'users')
      <li><a href="{{ url('/admin/users') }}"><i class="pe-7s-users"></i>Usuários</a></li>
      @endability
    </ul>
  </div>
</li>
...
<li>
  ...
  <div class="collapse" id="config_menu" aria-expanded="true">
    <ul class="nav">
      ...
      <li><a href="{{ url('/admin/airports') }}"><i class="pe-7s-map-marker"></i>Aeroportos</a></li>
      @endability
      ...
      @ability('admin', 'users')
      <li><a href="{!! url('/admin/roles') !!}"><i class="pe-7s-network"></i>Cargos</a></li>
      @endability

      @ability('admin', 'pages')
      <li><a href="{!! url('/admin/pages') !!}"><i class="pe-7s-note"></i>Paginas/Links</a></li>
      @endability

      @ability('admin', 'modules')
      <li><a href="{!! url('/admin/modules') !!}"><i class="pe-7s-box2"></i>Addons/Módulos</a></li>
      @endability

      @ability('admin', 'maintenance')
      <li><a href="{{ url('/admin/maintenance') }}"><i class="pe-7s-tools"></i>Manutenção</a></li>
      @endability

      @ability('admin', 'settings')
      <li><a href="{{ url('/admin/settings') }}"><i class="pe-7s-config"></i>Configurações</a></li>
      @endability
    </ul>
  </div>
</li>
